                ...
                <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                    ...
                    {/* {Data?.map((data)=>( */}
                        <div  className="relative">
                            ...
                            <img src={url} className="rounded-full shadow-md shadow-gray-200 dark:shadow-gray-800" alt=""/>
                    ...
                    <div className="lg:col-span-7">
                        <div className="lg:ms-5">
                            ...
                            <h3 className="mb-6 md:text-2xl text-xl md:leading-normal leading-normal font-semibold">{Data?.user?.about?.subTitle}</h3>

                            <p className="text-slate-400 max-w-xl text-[15px]">{Data?.user?.about?.description}</p>
                            <p className="text-slate-400 max-w-xl text-[15px] mt-6">{Data?.user?.about?.quote}</p>
