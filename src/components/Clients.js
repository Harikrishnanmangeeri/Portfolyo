...
const settings = {
    ...
    export default function Clients() {
        ...
        const Client = data?.user?.testimonials;
        ...
        <section className="relative md:py-24 py-16 bg-gray-50 dark:bg-slate-800" id="testi">
            <div className="container">
                <div className="grid grid-cols-1 pb-8 text-center">
                    <h3 className="mb-4 md:text-2xl text-xl md:leading-normal leading-normal font-semibold">Client's Review</h3>
                    <h5 className="mb-1 md:text-sm text-sm md:leading-normal leading-normal font-semibold">Testimonials</h5>
                                    ...
                                    <div className="tiny-slide" key={index}>
                                        ...
                                        <div className="customer-testi">
                                            <div className="content relative rounded shadow shadow-gray-200 dark:shadow-gray-800 m-2 p-6 bg-white dark:bg-slate-900">
                                                ...
                                                <p className="text-slate-400 text-[15px]">{item?.review}</p>
