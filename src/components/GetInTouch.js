                    ...
                    <div className="lg:ms-8">
                        <div className="flex">
                            ...
                            <div className="flex-1 ms-6">
                                ...
                                <Link to="tel:+152534-468-854" className="text-slate-400 text-[15px]">{user?.phoneNumber}</Link>
                            </div>
                        </div>
                        ...
                        <div className="flex mt-4">
                            ...
                            <div className="flex-1 ms-6">
                                ...
                                <Link to="mailto:contact@example.com" className="text-slate-400 text-[15px]">{Data?.user?.email}</Link>
                            </div>
                        </div>
                        ...
                        <div className="flex mt-4">
                            ...
                            <div className="flex-1 ms-6">
                                ...
                                <p className="text-slate-400 text-[15px] mb-2">{user?.address}</p>
                            </div>
                        </div>
                    </div>
                </div>
