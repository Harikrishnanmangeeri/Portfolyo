...
export default function Navbar(){
    ...
    return(
        ...
        <div className="container flex flex-wrap items-center justify-between">
            ...
            <h2 className="font-bold text-xl md:text-2xl lg:text-3xl inline-block">
      <span className="dark:hidden">John Doe</span>
      <span className="hidden dark:inline-block">John Doe</span>
    </h2>
            </Link>
            ...
            <div className="navigation lg_992:order-1 lg_992:flex hidden ms-auto" id="menu-collapse">
                <ul className="navbar-nav" id="navbar-navlist">
                    ...
                    <li className="nav-item">
                        <Link1 to="experience" activeClass="active" spy={true} smooth={true} duration={500} className="nav-link">Skills</Link1>
                    </li>
                    <li className="nav-item">
                        <Link1 to="project" activeClass="active" spy={true} smooth={true} duration={500} className="nav-link">Projects</Link1>
                    </li>
                    <li className="nav-item">
                        <Link1 to="blog" activeClass="active" spy={true} smooth={true} duration={500} className="nav-link">Social Handles</Link1>
                    </li>
                    <li className="nav-item">
